...
public class GiftProviderCacheKeyBuilder extends RedisKeyBuilder{
	...
	private static final String SKU_ORDER = "sku_order";
	private static final String SKU_ORDER_INFO = "sku_order_info";
	private static final String SKU_STOCK = "sku_stock";
	private static final String SKU_SEMAPHORE = "sku_semaphore";
	private static final String SKU_CLOSE_LIVING = "sku_close_live";
	...
	public String buildSkuCloseLiving(Long skuId){
		return super.getPrefix() + SKU_CLOSE_LIVING + super.getSplitItem() + skuId;
	}

	public String buildSkuSemaphore(Long skuId){
		return super.getPrefix() + SKU_SEMAPHORE + skuId;
	}
