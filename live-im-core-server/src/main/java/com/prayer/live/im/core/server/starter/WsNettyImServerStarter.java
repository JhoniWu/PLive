...
import com.prayer.live.im.core.server.common.WebsocketEncoder;
import com.prayer.live.im.core.server.handler.websocket.WsImServerCoreHandler;
import com.prayer.live.im.core.server.handler.websocket.WsSharkHandler;
...
public class WsNettyImServerStarter implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		nettyServerThread.setName("prayer-live-im-server-ws");
